...
public class TestGroupCourseDaoImpl {

    @Autowired
    private GroupCourseDaoImpl groupCourseDao;

    @Test
    public void test_insert() {
        DaoImplTestFixture f = new DaoImplTestFixture();
        GroupCourse groupCourse = f.createGroupCourse();

        groupCourseDao.insert(groupCourse);
    }
